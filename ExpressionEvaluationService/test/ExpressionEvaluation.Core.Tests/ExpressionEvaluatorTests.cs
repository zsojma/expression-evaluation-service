...
namespace ExpressionEvaluation.Core.Tests
{
    public class ExpressionEvaluatorTests
    {
        ...
        {
            // Arrange
            var input = new BinaryNode(new UnaryValueNode(2))
            {
                Rights =
                {
            ...
            var parser = new ExpressionEvaluator();
        ...
        {
            // Arrange
            var input = new BinaryNode(new UnaryPrefixNode(UnaryOperatorType.Minus,new UnaryValueNode(2)))
            {
                Rights =
                {
                    new BinaryNodeItem(BinaryOperatorType.Power, new UnaryValueNode(2))
        ...
        {
            // Arrange
            var power = new BinaryNode(new UnaryValueNode(2))
            {
                Rights =
                {
                    new BinaryNodeItem(BinaryOperatorType.Power, new UnaryValueNode(2))
