...
{
    internal class ParenthesesBlockOld
    {
        private readonly List<ParenthesesBlockOld> _innerBlocks = new List<ParenthesesBlockOld>();
        private string _innerBlocksPattern;
        private bool _valid;

        public ParenthesesBlockOld(string input)
        {
            Input = input;
            ParseInnerBlocks(input);
        }
